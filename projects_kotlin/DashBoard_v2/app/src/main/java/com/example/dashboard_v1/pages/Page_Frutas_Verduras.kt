...
import com.example.dashboard_v1.components.ListFrutasVerduras
...
//        verticalArrangement = Arrangement.spacedBy(3.dp),
        ...
        items(listaProductosFrutas_Verduras) { producto ->
            ProductCardFrutas_Verduras(producto = producto)
        }
    }
}

val listaProductosFrutas_Verduras = listOf(
    ListFrutasVerduras.FruVer01,
    ListFrutasVerduras.FruVer02,
    ListFrutasVerduras.FruVer03,
    ListFrutasVerduras.FruVer04,
)

@Composable
private fun ProductCardFrutas_Verduras(producto: ListFrutasVerduras) {
